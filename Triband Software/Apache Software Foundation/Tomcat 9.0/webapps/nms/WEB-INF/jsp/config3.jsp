								...
								<c:choose>
									...
									<c:when
										...
										<ul class="nav nav-tabs">
											...
											<%-- <c:choose>
												<c:when test="${repData.getGsmConnected() == '1'}">
													<li class="active"><a data-toggle="tab" href="#gsm"><b>GSM</b></a></li>
												</c:when>
												<c:otherwise>
													<li class="disabled"><a href="#gsm"
														title='Not connected'><b>GSM</b></a></li>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${repData.getDcsConnected() == '1'}">
													<li><a data-toggle="tab" href="#dcs1"><b>DCS-1</b></a></li>
												</c:when>
												<c:otherwise>
													<li class="disabled"><a href="#dcs1"
														title='Not connected'><b>DCS-1</b></a></li>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${repData.getDcsConnected() == '1'}">
												...
												<c:otherwise>
													<li class="disabled"><a href="#dcs2"
														title='Not connected'><b>DCS-2</b></a></li>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${repData.getUmtsConnected() == '1'}">
													<li><a data-toggle="tab" href="#umts"><b>WCDMA</b></a></li>
												</c:when>
												<c:otherwise>
													<li class="disabled"><a href="#umts"
														title='Not cgmonnected'><b>WCDMA</b></a></li>
												</c:otherwise>
											</c:choose> --%>
											<li class="active"><a data-toggle="tab" href="#gsm"><b>GSM</b></a></li>
											<li><a data-toggle="tab" href="#dcs1"><b>DCS-1</b></a></li>
											<c:choose>
												<c:when test="${band_dcs2 == 'DCS2'}">
													<li><a data-toggle="tab" href="#dcs2"><b>DCS-2</b></a></li>
												</c:when>
											</c:choose>
											<li><a data-toggle="tab" href="#umts"><b>WCDMA</b></a></li>
									...
									<c:when
										...
										<ul class="nav nav-tabs">
											...
											<%-- <c:choose>
												...
												<c:otherwise>
													<li class="disabled"><a href="#gsm"
														title='Not connected'><b>850 MHz</b></a></li>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${repData.getDcsConnected() == '1'}">
													<li><a data-toggle="tab" href="#dcs1"><b>1900
																MHz</b></a></li>
												</c:when>
												<c:otherwise>
													<li class="disabled"><a href="#dcs1"
														title='Not connected'><b>1900 MHz</b></a></li>
												</c:otherwise>
											</c:choose>
											<c:choose>
												<c:when test="${repData.getUmtsConnected() == '1'}">
												...
												<c:otherwise>
													<li class="disabled"><a href="#umts"
														title='Not connected'><b>AWS</b></a></li>
												</c:otherwise>
											</c:choose> --%>
											...
											<form:form id="RepeaterDtaForm"
												...
												<%-- <div class="row">
														...
														<c:if test="${userDetails.getRoleId() !='6'}">
															<div class="col-sm-5">
																<button type="submit" class="btn btn-primary" id="apply">ApplySettings</button>
															</div>
														</c:if>

														<div class="col-sm-5">

															<form:input path="gsmversion" class="form-control"
																id="gsmversion" name="gsmversion" readonly="true"
																value="${repParams.get(loop.index).getFirmwareVersion()}" />
														</div>
																...
																<div class="col-lg-4">
																	<table class="table-striped">
																		<tbody>
																			...
																			<tr>
																				<td align="center"><label for="alclvlon_off"><h4>
																							<b>ALC ON/OFF </b>
																						</h4></label></td>
																				<c:if
													...
													<div class="col-lg-8">
														...
														<c:if test="${userDetails.getRoleId() !='6'}">
															<div align="center" class="col-sm-4">
																<button type="submit" class="btn btn-success"
																	id="apply4">ApplySettings</button>
															</div>
														</c:if>
													</div>
																				...
																				<table class="table table-striped">
																					...
																					Channel</form:label></td>
																							...
																							<td><b><form:input path="stopchd11"
																										class="form-control" type="number" min="512"
																										max="885" onblur="cfCalculatorDCS1h1();"
																										value="${humpParams.get(loop.index).getStopChannel() }" /></b></td>
																							<td></td>
																							<td></td>
																							<td></td>
																				...
																				<table class="table table-striped">
																					...
																					Channel</form:label></td>
																							...
																							<td><b><form:input path="startchd12"
																										class="form-control" type="number" min="512"
																										max="885" onblur="cfCalculatorDCS1h2();"
																										value="${humpParams.get(loop.index).getStartChannel() }" /></b></td>
																							<td></td>
																			...
																			<tbody>
																				...
																				<tr>
																					...
																					<td><b><form:input path="startchd13"
																								class="form-control" type="number" min="512"
																								max="885" onblur="cfCalculatorDCS1h3();"
																								value="${humpParams.get(loop.index).getStartChannel() }" /></b></td>
																					<td></td>
																					<td></td>
																					<td></td>
																			...
																			<tbody>
																				...
																				<tr>
																					...
																					<td><b><form:input path="startchd14"
																								class="form-control" type="number" min="512"
																								max="885" onblur="cfCalculatorDCS1h4();"
																								value="${humpParams.get(loop.index).getStartChannel() }" /></b></td>
																					<td></td>
																			...
																			<div class="col-sm-4">
																				...
																				<table class="table-striped">
																					<tbody>
																						...
																						<tr>
																							<td><label for="alclvlon_off">ON/OFF
																							</label></td>
																							<c:if
																								test="${repParams.get(loop.index).getAlcStatus()=='1'}">
																								<td><form:checkbox path="alclvlon_off"
																				...
																				<tr>
																					...
																					<c:choose>
																						<c:when
																							...
																							<td class="col-sm-2"><form:select
																									path="TotalHump">
																									<form:option value="${dcs2HumpCount}"
																										label="${dcs2HumpCount}" />
																									<option value="0">0</option>
																									<option value="1">1</option>
																									<option value="2">2</option>
																					...
																					<td><form:label path="bwg0"
																							class=" control-label">Total Hump</form:label></td>
																				</tr>
																			</tbody>
																		</table>
																		<c:choose>
																					...
																					<div class="panel-heading">
																						...
																						<div class="panel-options">
																							...
																							<a href="#" data-rel="collapse"><i
																								...
																								data-rel="close"><i class="entypo-cancel"></i></a>
																						</div>
																					</div>
													...
													<div class="row">
														<div class="col-lg-8">
															...
															<div class="col-sm-6">
																...
																<form:label path="umtsversion" class="control-label">Version</form:label>

																<span><b><form:input path="umtsversion"
																			class="form-controlnew" id="umtsversion"
																			name="umtsversion" readonly="true"
																			value="${repParams.get(loop.index).getFirmwareVersion()}" /></b></span>
