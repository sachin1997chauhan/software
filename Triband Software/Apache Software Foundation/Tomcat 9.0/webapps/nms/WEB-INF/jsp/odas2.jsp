		...
		<div class="sidebar-menu">
			...
			<div class="sidebar-menu-inner">
				...
				<header class="logo-env">
					...
					<div class="logo">
						<a href="/nms/dashboardView.htm"> <!-- <img src="resources/neon/assets/images/logo-nms.png" width="120" alt="" /> -->
							...
							height="30" width="100" /><br />
						<br /> <br /> <span class="title"><strong><font
									color="green">NMS Version 1.0.0.0</font></strong></span>
						</a>
					</div>
				...
				<ul id="main-menu" class="main-menu">
					...
					<li><a href="/nms/dashboardView.htm"> <i
							class="entypo-home"></i> <span class="title">Dashboard</span>
					</a></li>

					<li class="active opened"><a href="/nms/RepeaterList.htm">
							<i class="entypo-list"></i> <span class="title">Site List</span>
					</a></li>
